...
/**
 Base class for all Practica2Mapes views.
 @see TiViewProxy
 */
#ifdef TI_USE_AUTOLAYOUT
...
/**
 Whether or not a view not normally picked up by the Practica2Mapes view hierarchy (such as wrapped iOS UIViews) was touched.
