...
//Rare exceptions to indicate a bug in the _practica2mapes code (Eg, function that a subclass should have implemented)
...
/**
 The base class for Practica2Mapes proxies.
 */
