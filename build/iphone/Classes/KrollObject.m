...
//@interface Practica2MapesObject : NSObject
//@end

@interface Practica2MapesObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[Practica2MapesObject class]])
		{
			for (NSString *key in [[(Practica2MapesObject*)o modules] allKeys])
			{
