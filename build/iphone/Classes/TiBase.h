...
// in simulator we redefine to format for Practica2Mapes Developer console
...
{\
	NSString * exceptionName = [@"org.practica2mapes." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.practica2mapes";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UIPractica2MapesNativeItemNone = -1, 
	UIPractica2MapesNativeItemSpinner = -2,
	UIPractica2MapesNativeItemProgressBar = -3,
	
	UIPractica2MapesNativeItemSlider = -4,
	UIPractica2MapesNativeItemSwitch = -5,
	UIPractica2MapesNativeItemMultiButton = -6,
	UIPractica2MapesNativeItemSegmented = -7,
	
	UIPractica2MapesNativeItemTextView = -8,
	UIPractica2MapesNativeItemTextField = -9,
	UIPractica2MapesNativeItemSearchBar = -10,
	
	UIPractica2MapesNativeItemPicker = -11,
	UIPractica2MapesNativeItemDatePicker = -12,
	
	UIPractica2MapesNativeItemInfoLight = -13,
	UIPractica2MapesNativeItemInfoDark = -14,
	
	UIPractica2MapesNativeItemDisclosure = -15,
	
	UIPractica2MapesNativeItemContactAdd = -16
};
...
#endif
/**
 *	TiThreadPerformOnMainThread should replace all Practica2Mapes instances of
