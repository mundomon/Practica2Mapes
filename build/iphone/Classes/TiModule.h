...
/**
 The base class for all Practica2Mapes modules
 */
...
/**
 Practica2Mapes Platform calls this method on startup.
 */
-(void)startup;

/**
 Practica2Mapes Platform calls this method on shutdown.
 @param sender The sender of the event.
 */
-(void)shutdown:(id)sender;

/**
 Practica2Mapes Platform calls this method on suspend.
 @param sender The sender of the event.
 */
-(void)suspend:(id)sender;

/**
 Practica2Mapes Platform calls this method on entering background.
 @param sender The sender of the event.
 */
-(void)paused:(id)sender;

/**
 Practica2Mapes Platform calls this method on resume.
 @param sender The sender of the event.
 */
