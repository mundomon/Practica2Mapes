...
@interface Practica2MapesObject : KrollCoverageObject {
#else
@interface Practica2MapesObject : KrollObject {
#endif
@private
...
extern NSString * Practica2Mapes$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	Practica2MapesObject *_practica2mapes;
    KrollObject* console;
	BOOL shutdown;
